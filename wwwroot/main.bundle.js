...
//# sourceMappingURL=calculation.routing.js.map
...
var AppComponent = (function () {
    function AppComponent(viewContainerRef, auth) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_app_services_project_service__ = __webpack_require__("./src/app/services/project.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_ngx_bootstrap_modal__ = __webpack_require__("./node_modules/ngx-bootstrap/modal/index.js");
...
//import { NgxDatatableCaseComponent } from 'overheadlines';
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__services_auth_auth_guard_service__["a" /* AuthGuard */],
                __WEBPACK_IMPORTED_MODULE_15_app_services_project_service__["a" /* ProjectService */],
                __WEBPACK_IMPORTED_MODULE_0__services_show_data_service__["a" /* ShowDataService */],
                // ENV_PROVIDERS,
                APP_PROVIDERS,
            ]
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_core__["ApplicationRef"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_core__["ApplicationRef"]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_9__app_service__["a" /* AppState */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__app_service__["a" /* AppState */]) === "function" && _b || Object])
    ], AppModule);
    return AppModule;
    var _a, _b;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_layout_app_layouts_main_layout_component__ = __webpack_require__("./src/app/shared/layout/app-layouts/main-layout.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__callback_callback_component__ = __webpack_require__("./src/app/callback/callback.component.ts");
/* unused harmony export routes */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return routing; });
...
var routes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_2__shared_layout_app_layouts_main_layout_component__["a" /* MainLayoutComponent */],
    ...
    { path: 'callback', component: __WEBPACK_IMPORTED_MODULE_3__callback_callback_component__["a" /* CallbackComponent */] },
    { path: '**', redirectTo: 'home', pathMatch: 'full' },
];
var routing = __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* RouterModule */].forRoot(routes, { useHash: false, enableTracing: false }); //  zmieniłem useHash na false, enabletracing tylko do debugowania
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_delay__ = __webpack_require__("./node_modules/rxjs/add/operator/delay.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_do__ = __webpack_require__("./node_modules/rxjs/add/operator/do.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__guards_module_import_guard__ = __webpack_require__("./src/app/core/guards/module-import-guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__shared_voice_control_voice_recognition_service__ = __webpack_require__("./src/app/shared/voice-control/voice-recognition.service.ts");
    ...
    CoreModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_9_ngx_bootstrap__["c" /* TooltipModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_9_ngx_bootstrap__["a" /* BsDropdownModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_9_ngx_bootstrap__["d" /* ProgressbarModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_9_ngx_bootstrap__["e" /* AlertModule */].forRoot(),
...
var AuthService = (function () {
    ...
    AuthService.prototype.handleAuthentication = function () {
        var _this = this;
        //alert("JESTEM W HANDLEAUTH");
        this.auth0.parseHash(function (err, authResult) {
            if (authResult && authResult.accessToken && authResult.idToken) {
                window.location.hash = '';
                _this.setSession(authResult);
                setTimeout(function () { return _this.router.navigate(['/home']); }, 500); //nie za dobre rozwiązanie pewnie
...
var ProjectService = (function () {
    function ProjectService(http) {
        ...
        this.projectName = new __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__["BehaviorSubject"]("Project not opened");
        this.currentProjectName = this.projectName.asObservable();
        //id projektu jest obserwowana
        this.projectId = new __WEBPACK_IMPORTED_MODULE_2_rxjs_BehaviorSubject__["BehaviorSubject"](0);
        this.currentProjectId = this.projectId.asObservable();
        this.selectedProject = {};
    }
    ProjectService.prototype.changeProjectName = function (name) {
        this.projectName.next(name);
    };
    ProjectService.prototype.changeProjectId = function (id) {
        this.projectId.next(id);
    };
    ProjectService.prototype.getProjects = function () {
        //wczytaj dane z bazy danych
        return this.http.get('/Project/Get').map(function (res) { return res.json(); });
    };
    ProjectService.prototype.createProject = function (newProjectName) {
        var _this = this;
        ...
        this.http.post('/Project/CreateProject/', JSON.stringify({ LastUpdate: "0001-01-01 00:00:00.0000000", Name: newProjectName }), { headers: headers }).subscribe(function (data) {
            _this.getProjects().subscribe(function (projects) {
                _this.projects = projects;
                _this.selectedProject = _this.projects.find(function (p) { return p.name == newProjectName; });
                console.log("this.projects.toString()" + _this.projects.find(function (p) { return p.name == newProjectName; }).name);
                console.log("this.newProjectName" + newProjectName);
                console.log("this.selectedProject.id" + _this.selectedProject.id);
                _this.changeProjectId(_this.selectedProject.id);
            });
        });
...
var ShowDataService = (function () {
    function ShowDataService() {
        this.showState = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["BehaviorSubject"](false);
        this.currentShow = this.showState.asObservable();
    }
    ShowDataService.prototype.showIt = function () {
...
//# sourceMappingURL=show-data.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__i18n_i18n_module__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.module.ts");
    ...
    HeaderModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_17_ngx_bootstrap__["a" /* BsDropdownModule */],
...
var RecentProjectsComponent = (function () {
    // id: number;
    function RecentProjectsComponent(projectService) {
        this.projectService = projectService;
    }
    RecentProjectsComponent.prototype.ngOnInit = function () {
        // this.projects = this.projectsServiceSA.getProjects()
        var _this = this;
        this.projectService.currentProjectName.subscribe(function (name) { return _this.name = name; });
    ...
    RecentProjectsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__services_project_service__["a" /* ProjectService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__services_project_service__["a" /* ProjectService */]) === "function" && _a || Object])
...
/***/ "./src/app/shared/layout/i18n/i18n.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__language_selector_language_selector_component__ = __webpack_require__("./src/app/shared/layout/i18n/language-selector/language-selector.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__i18n_pipe__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__i18n_service__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.service.ts");
    ...
    I18nModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_5_ngx_bootstrap__["a" /* BsDropdownModule */],
            ],
            declarations: [
...
/***/ "./src/app/shared/layout/i18n/i18n.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__i18n_service__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.service.ts");
...
/***/ "./src/app/shared/layout/i18n/i18n.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__languages_model__ = __webpack_require__("./src/app/shared/layout/i18n/languages.model.ts");
...
/***/ "./src/app/shared/layout/i18n/language-selector/language-selector.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/shared/layout/i18n/language-selector/language-selector.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__languages_model__ = __webpack_require__("./src/app/shared/layout/i18n/languages.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__i18n_service__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.service.ts");
...
var LanguageSelectorComponent = (function () {
    ...
    LanguageSelectorComponent = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/shared/layout/i18n/language-selector/language-selector.component.html"),
        }),
...
/***/ "./src/app/shared/layout/i18n/languages.model.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__data_data_module__ = __webpack_require__("./src/app/+data/data.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__calculation_calculation_module__ = __webpack_require__("./src/app/+calculation/calculation.module.ts");
    ...
    SmartadminLayoutModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap__["c" /* TooltipModule */],
                __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap__["a" /* BsDropdownModule */],
                __WEBPACK_IMPORTED_MODULE_16__data_data_module__["DataModule"],
                __WEBPACK_IMPORTED_MODULE_17__calculation_calculation_module__["CalculationModule"],
            ],
            declarations: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__i18n_i18n_module__ = __webpack_require__("./src/app/shared/layout/i18n/i18n.module.ts");
...
var SmartMenuDirective = (function () {
    function SmartMenuDirective(menu, router, layoutService, showDataService) {
        var _this = this;
        this.menu = menu;
        this.router = router;
        this.layoutService = layoutService;
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            animations: [
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["a" /* trigger */])('shortcutState', [
                    ...
                    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["d" /* transition */])('in => out', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["e" /* animate */])('250ms 300ms ease-out'))
                ])
            ]
        }),
...
var config = {
    ...
    skins: [
        {
            name: "smart-style-4",
            logo: "assets/img/electrisim-white.svg",
...
var LogoutComponent = (function () {
    function LogoutComponent(router, notificationService, auth, showData) {
        this.router = router;
        this.notificationService = notificationService;
        this.auth = auth;
...
var CommandsHelpComponent = (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["c" /* ModalDirective */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ngx_bootstrap_modal__["c" /* ModalDirective */]) === "function" && _a || Object)
...
var VoiceControlModule = (function () {
    ...
    VoiceControlModule = VoiceControlModule_1 = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_2_ngx_bootstrap__["b" /* ModalModule */], __WEBPACK_IMPORTED_MODULE_3__sound_sound_module__["a" /* SoundModule */], __WEBPACK_IMPORTED_MODULE_4__utils_utils_module__["a" /* UtilsModule */]
            ],
...
var VoiceControlService = (function () {
    ...
    VoiceControlService_1 = VoiceControlService;
    VoiceControlService.prototype.attachHelp = function () {
        var _this = this;
        if (this.state.available && !VoiceControlService_1.helpModal) {
            setTimeout(function () {
                var component = _this.componentFactoryResolver.resolveComponentFactory(__WEBPACK_IMPORTED_MODULE_2__commands_help_component__["a" /* CommandsHelpComponent */]);
                var viewContainerRef = _this.app['_rootComponents'][0]._component.viewContainerRef;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_add_operator_mergeMap__ = __webpack_require__("./node_modules/rxjs/add/operator/mergeMap.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_imports_loader_jQuery_jquery_jquery_color_jquery_color_js__ = __webpack_require__("./node_modules/imports-loader/index.js?jQuery=jquery!./node_modules/jquery-color/jquery.color.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_bootstrap__ = __webpack_require__("./node_modules/bootstrap/dist/js/npm.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_platform_browser_dynamic__ = __webpack_require__("./node_modules/@angular/platform-browser-dynamic/@angular/platform-browser-dynamic.es5.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_app_module__ = __webpack_require__("./src/app/app.module.ts");
...
if (__WEBPACK_IMPORTED_MODULE_6__environments_environment__["a" /* environment */].production) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["enableProdMode"])();
}
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__angular_platform_browser_dynamic__["a" /* platformBrowserDynamic */])().bootstrapModule(__WEBPACK_IMPORTED_MODULE_7__app_app_module__["a" /* AppModule */]);
